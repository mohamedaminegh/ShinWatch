      ...
      <div className="container">
        <div className="row">
          <div className="col-md-8 m-auto">
            ...
            <small  className="font-italic" >Only the handle and status are required </small>
            <form onSubmit={this.onSubmit}>
              <TextFieldGroup
                ...
                onChange={this.onChange}
                error={errors.handle}
                info="A unique handle for you to use on this website"
              />
              <SelectListGroup
                placeholder="Status"
                name="status"
                ...
                options={options}
                error={errors.status}
                info="Give us an idea on what you do"
              />
